...
const site_url = 'https://www.docsy.live/'
export const metadata: Metadata = {
  ...
  description:
    'Transform your GitHub documentation into an intelligent Q&A system. Drop-in RAG component for React and Next.js applications.',
  keywords: [
    'RAG',
    'documentation',
    'AI',
  ...
  openGraph: {
    ...
    description:
      'Transform your GitHub documentation into an intelligent Q&A system.',
    siteName: 'Docsy',
    images: [
      {
        url: `og-image.png`,
